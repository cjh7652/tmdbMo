        ...
        <div className='home'>
           ...
           <div className="search">
                <div className="searchBox">
                    <input type="secrch" value={searchWord} onChange={(e) =>setSearchWord(e.target.value) } onKeyDown={handleKeyPress} placeholder='영화제목을 입력해주세요' />
                                ...
                                
                                {
                                    recommend.map((rec) => (
                                        <SwiperSlide key={rec.id} className='recommendSlider'>
                                            <Link to={`/recommendDetail/${rec.id}`}> <img src={`https://image.tmdb.org/t/p/w500${rec.poster_path}`} alt={rec.title}/></Link>
                                        </SwiperSlide>
                                    ))
                                }
                            </Swiper>
